...
var blueRectangle = new Rectangle([0, 0], 10, 20, "#0066ff");
var greenTriangle = new Triangle([1, 1],[2, 2],[3, 3], "#00ff55");
var yellowLine = new Line([3, 3], [4, 4], "#ffff00");
var purpleSegment = new Segment([5, 5], [0, 0], "#cc0099");
